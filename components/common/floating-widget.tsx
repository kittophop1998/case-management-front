...
export const FloatingWidget = ({ title, status, setStatus, children }: FloatingWidgetProps) => {
    ...
    return (
        <div className={
            cn('fixed z-50', (isSmallMod || isHidden) ? 'right-0 bottom-0 max-h-[70vh] w-[clamp(432px,40vw,300px)] shadow-xl' : 'inset-0  flex items-center justify-center bg-[#A3A3A3]/20 backdrop-blur-xs', status ? '' : 'hidden')
        }>
